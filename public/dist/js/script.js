...
$(function() {
  $(".youtube-video").each(function() {
    ...
    $(this).css({
      "background-image":
        "url(https://img.youtube.com/vi/" + this.id + "/0.jpg)",
    });
    ...
    $(document).delegate("#" + this.id, "click", function() {
      ...
      var iframe_url =
        "https://www.youtube.com/embed/" + this.id + "?autoplay=0&autohide=1";
...
$(document).ready(function() {
  ...
  $(".expanded").click(function() {
    $(this)
      .children(".dropdown_sidebar_menu")
      .toggleClass("active");
    $(this)
      .next(".dropdown_sidebar_menu")
      .toggleClass("active");
  });
...
$(document).ready(function() {
  ...
  if (isMobile) {
    ...
    function sizeContent() {
      ...
      $("#block-cart .dropdown.dropdown-cart .product").css(
        "height",
        newHeight - 114
      );
    }
...
$("#prem .field-content").viewportChecker({
  callbackFunction: function(elem, action) {
    $("#prem .field-content .row-1 .field-text").animateNumber(
      { number: 2800 },
      1500
    );
    $("#prem .field-content .row-2 .field-text").animateNumber(
      { number: 4000 },
      1500
    );
    $("#prem .field-content .row-3 .field-text").animateNumber(
      { number: 9580000 },
      1500
    );
    $("#prem .field-content .row-4 .field-text").animateNumber(
      { number: 874592 },
      1500
    );
    offset: 0;
...
$('.option.fav input[type="checkbox"]').click(function() {
  if ($(this).prop("checked")) {
    ...
    $(this)
      .parent()
      .find(".tooltip_add_too ")
      .animate({ left: "0" }, 300)
      .delay(2000)
      .animate({ left: "-120px" }, 300);
  } else {
    $(this)
      .parent()
      .find("label")
...
$(function() {
  $(document).click(function(event) {
    if ($(event.target).closest(".mobile-menu.active,.mobile-menu-btn").length)
      return;
